...
def handle_crowd_data(data):
    ...
    socketio.emit('crowd_update', data, broadcast=True)
...
def handle_crowd_video(data):
    ...
    socketio.emit('crowd_video_update', data, broadcast=True)
...
def handle_environment_data(data):
    ...
    socketio.emit('environment_update', data, broadcast=True)
...
def handle_feedback_data(data):
    ...
    socketio.emit('feedback_update', data, broadcast=True)
...
def handle_send_test_data_module5(data):
    ...
    socketio.emit('DisplayUpdate', test_data, broadcast=True)
